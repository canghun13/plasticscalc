...
- The shared stylesheet reference now carries the explicit `v=20260718-layout` deployment version. This is a targeted cache-busting reference for this layout release only, so a browser cannot combine newly generated HTML with a stale shared stylesheet during GitHub Pages propagation.
