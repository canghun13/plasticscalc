...
### 2026-09-01 — Aggressive workflow discovery: Plastic Film & Flexible Packaging Test Data Reduction GO

#### Repository safety and baseline

- Actual repository: `C:\Users\song\Documents\ChatGPT\plasticscalc\canonical`; remote: `https://github.com/canghun13/plasticscalc.git`; branch: `main`.
- Start commit: `d7d9600fba14fb5ddae98ff694a480cce1405533`. Before work, local `HEAD`, `origin/main`, and `git ls-remote origin refs/heads/main` all matched this SHA and the working tree was clean.
- Pre-work inventory: 96 public HTML files, 95 indexable/self-canonical sitemap URLs, and 58 calculator pages/registry entries. No first-party GSC, GA4, or Bing export was present in the repository, so no traffic numbers were invented.
- Exclusion set applied before discovery: all implemented Mold Cooling/Thermal Control, Process Validation/Stability, Energy Measurement/Efficiency, Part Design/DFM, and Extrusion Setup/Line Balance decisions; the 39 recently reviewed families listed in the task (drying through shutdown/restart preservation); the nine existing-page upgrade ideas (runner-volume through masterbatch workflow); and all 50 previous extrusion, blow molding, thermoforming, recycling, pressure-decay, mold-RFQ, and mold-repair families. Film-production planning was excluded; laboratory reduction of measured film-test observations is a different user, workflow stage, input set, output, and next decision.

#### Broad discovery — 50 genuinely new workflow/search families

Abbreviations: `U/W` = target user and repeated workflow; `Q` = representative real query; `T` = likely tool types and independent depth; `O/S` = existing-site overlap and initial free-SERP state. Each row was counted by workflow/search intent, not by metric/US, forward/reverse, or presentation variants.

| # | Family | U/W | Q | T / depth / repeat reason | O/S | Verdict |
|---:|---|---|---|---|---|---|
| 1 | Thin-film tensile reduction | film QA; reduce each specimen/lot | `plastic film tensile strength calculator` | calculators for strength, elongation, section check, replicate summary; 4+; every lot/trial | none; standards/services dominate, interactive gap | GO |
| 2 | Film coefficient-of-friction QC | converting/packaging QA; reduce sled traces | `plastic film coefficient of friction calculator` | static/kinetic COF, trace interval, replicate comparator, direction record; 4+ | none; equipment vendors explain but do not cover workflow | GO |
| 3 | Flexible-package seal-strength normalization | packaging lab; normalize peel traces | `seal strength N 15 mm calculator` | peak/average normalization, width conversion, replicate/failure-mode comparator, window summary; 4+ | none; test-machine and standards pages dominate | GO |
| 4 | Film dart-impact group reduction | film lab; reduce each group series | `dart impact failure weight calculation plastic film` | successive-group, staircase, group validator, replicate/lot comparator; 4+ | none; method/equipment pages, little free interaction | GO |
| 5 | Film haze/transmittance reduction | optical QA; reduce instrument readings | `plastic film haze calculation T1 T2 T3 T4` | corrected haze, transmittance, reading validator, position summary; 4+ | none; formula/standard pages fragmented | GO |
| 6 | Bulk-plastic tensile specimen reduction | polymer lab; normalize tensile pulls | `plastic tensile stress elongation calculator` | stress/strain, modulus-window, yield/break, replicate summary; 4+ | adjacent to #1, not existing site; mixed generic calculators | HOLD |
| 7 | Plastic flexural-test reduction | polymer lab; process beam tests | `3 point bend flexural strength plastic calculator` | stress, strain, tangent modulus, span/specimen check; 4+ | none; generic beam tools miss plastics test basis | HOLD |
| 8 | Notched impact normalization | polymer QC; normalize Izod/Charpy breaks | `notched Izod impact strength calculator` | energy/width, residual ligament, notch check, replicate summary; 4+ | none; mostly services/equipment | HOLD |
| 9 | Melt-flow cutoff batch analysis | resin QC; weigh timed cuts | `melt flow index calculator cut weights` | MFR, MVR, density conversion, cut outlier/replicate review; 4+ | not extrusion output; isolated simple MFI tools exist | HOLD |
| 10 | Immersion density/specific-gravity QC | resin/part lab; reduce weighings | `ASTM D792 specific gravity calculator` | SG, density, liquid correction, replicate/bubble warning; 4+ | materials page only; service/quote SERP | GO |
| 11 | Ash/inorganic filler content | compound QC; reduce crucible masses | `plastic ash content calculator` | ash %, filler estimate, moisture/volatile split, replicate summary; 4+ | none; standards/services dominate | GO |
| 12 | DSC crystallinity reduction | polymer lab; integrate thermal results | `DSC percent crystallinity calculator` | single/multicomponent crystallinity, cold-crystallization correction, filler correction, replicate comparison; 4+ | none; one strong single calculator exists | GO |
| 13 | TGA staged mass-loss analysis | polymer lab; reduce temperature plateaus | `TGA mass loss calculation polymer filler` | moisture, polymer loss, residue, staged composition comparator; 4+ | none; analysis articles/software dominate | HOLD |
| 14 | Capillary-rheometer apparent flow reduction | rheology lab; reduce pressure/flow points | `capillary rheometer shear rate viscosity calculator` | apparent shear rate/stress/viscosity and corrections; 4+ | not molding viscosity curve; specialist software strong | HOLD |
| 15 | DMA viscoelastic reduction | materials lab; compare sweeps | `DMA storage loss modulus tan delta calculator` | tan delta, complex modulus, transition picker, normalized comparator; 4+ | none; instrument software dominates | HOLD |
| 16 | Vicat/HDT setup and result records | polymer QC; prepare load/geometry runs | `HDT load calculation specimen plastic` | stress/load, span geometry, temperature-rate schedule, replicate report; 4+ | not mold cooling; standards/services dominate | HOLD |
| 17 | Film tear-propagation normalization | film QA; reduce pendulum readings | `plastic film Elmendorf tear strength calculator` | force/thickness, direction comparison, pendulum-range check, replicate summary; 4+ | none; equipment pages dominate | HOLD |
| 18 | Accelerated thermal-aging planning | reliability lab; plan exposure equivalents | `polymer accelerated aging calculator Arrhenius` | equivalent time, acceleration factor, scenario comparator, schedule generator; 4+ | not post-mold conditioning; free single tools exist | GO |
| 19 | UV/weathering exposure-dose planning | polymer reliability; compare lamp cycles | `UV weathering exposure dose calculator plastic` | radiant dose, light/dark cycle, condensation share, schedule/coupon capacity; 4+ | none; equipment/articles, few planners | HOLD |
| 20 | Thermal-cycle chamber scheduling | reliability lab; size cycles and throughput | `thermal cycling chamber test time calculator` | cycle duration, ramp/dwell, total exposure, chamber capacity; 4+ | not mold thermal control; generic duration tools | HOLD |
| 21 | Chemical-immersion retention/uptake | polymer compatibility lab; weigh/measure coupons | `plastic chemical resistance weight change calculator` | mass/size change, property retention, surface-area normalization, replicate comparator; 4+ | none; lookup charts rather than reduction tools | GO |
| 22 | Environmental stress-crack load/time planning | polymer lab; set bent-strip/loading tests | `environmental stress cracking plastic test load calculator` | strain geometry, load/stress, failure-time survival, replicate summary; 4+ | none; standards/services dominate | HOLD |
| 23 | Polymer creep and time-temperature shift | design/reliability; normalize creep series | `plastic creep time temperature superposition calculator` | creep strain/compliance, shift factors, master-curve checks, scenario comparison; 4+ | none; CAE/research software strong | HOLD |
| 24 | OTR/WVTR test normalization | barrier lab; normalize measured transmission | `OTR WVTR calculator film area thickness` | rate, permeance, permeability, condition normalization, replicate summary; 4+ | none; several isolated calculators | GO |
| 25 | Multilayer barrier resistance | package engineer; combine layer properties | `multilayer film oxygen transmission rate calculator` | series resistance, layer contribution, sensitivity, target layer solver; 4+ | none; one vendor/Japanese calculator, limited interpretation | GO |
| 26 | Package oxygen/moisture ingress | package engineer; predict headspace/product exposure | `package oxygen ingress calculator OTR area` | steady ingress, initial headspace, shelf-life threshold, scenario comparator; 4+ | distinct from packaging handoff; spreadsheets/articles fragmented | GO |
| 27 | Desiccant sizing from measured barrier | package engineer; size moisture capacity | `desiccant amount calculator package WVTR` | ingress load, headspace load, capacity/derating, replacement interval; 4+ | none; vendor tools often product-specific | HOLD |
| 28 | Heat-seal window test-matrix analysis | flexible-packaging lab; map seal trials | `heat seal window calculator temperature dwell pressure` | matrix analyzer, threshold band, plateau selector, replicate comparator; 4+ | none; equipment/software and spreadsheets | GO |
| 29 | Shrink-film free-shrink/shrink-force QC | film lab; reduce directional specimens | `shrink film percent shrinkage calculator` | MD/TD shrink, force/stress, temperature comparator, lot summary; 4+ | not blown-film planning; simple percent calculators | HOLD |
| 30 | Film puncture/burst result normalization | packaging lab; normalize probe/burst data | `film puncture energy calculator` | peak force, energy, thickness/area normalization, replicate summary; 4+ | none; test-machine software dominates | HOLD |
| 31 | Plastic CNC trial feeds/speeds normalization | machinist; record each material/tool trial | `feeds and speeds calculator for plastics` | rpm, feed, chip load, MRR, heat-risk record; 4+ | none; strong generic machining calculators | GO |
| 32 | Vacuum hold-down workholding | plastics fabricator; size sheet hold force | `vacuum hold down force calculator sheet` | area/force, leakage margin, zone sizing, cut-release check; 4+ | none; generic vacuum calculators | HOLD |
| 33 | Machining thermal-expansion tolerance compensation | plastics machinist/inspector; compare temperatures | `plastic thermal expansion tolerance calculator` | dimensional shift, bilateral tolerance, soak scenario, inspection correction; 4+ | none; generic expansion calculators | HOLD |
| 34 | Plastic sheet cut/yield/kerf planning | fabricator; nest/cut repeated jobs | `plastic sheet cutting yield calculator kerf` | grid/nest yield, kerf, remnant, cost; 4+ | none; strong sheet optimizers often generic/SaaS | HOLD |
| 35 | Plastic stock weight planning | purchasing/fabrication; quote sheet/rod/tube | `plastic sheet rod tube weight calculator` | sheet/rod/tube weight, cut-list total, purchase pack; 4+ | materials weight adjacent; many free calculators | DROP |
| 36 | Acrylic/plastic line-bending geometry | sign/display shop; set bend line/heater | `acrylic line bending allowance calculator` | bend allowance/setback, heater position, developed length, multi-bend layout; 4+ | none; guides dominate, few tools | GO |
| 37 | Laser-cut plastics kerf/test-coupon planning | laser operator; calibrate new sheet/lot | `acrylic laser kerf compensation calculator` | kerf coupon, dimension offset, array generator, trial comparator; 4+ | none; machine-specific guidance | HOLD |
| 38 | Plastic drilling chip-load/peck planning | machinist; plan hole trial | `drilling acrylic plastic feed speed calculator` | rpm/feed/chip load, peck count, heat-clearance checklist; 4+ | none; machining sites cover most arithmetic | HOLD |
| 39 | Plastic tapping/thread-engagement planning | machinist/designer; set internal threads | `thread engagement calculator plastic tapped hole` | engagement, pilot diameter, torque screen, pullout estimate; 4+ | DFM adjacent but not molded feature screen; source/model risk | HOLD |
| 40 | Saw-cut tooth engagement and feed planning | plastics fabricator; select trial settings | `plastic sheet saw blade feed rate calculator` | tooth engagement, feed/tooth, cut time, heat-load record; 4+ | none; vendor articles, no coherent free cluster | HOLD |
| 41 | Plastic gloss measurement batch reduction | surface/film QA; summarize readings | `gloss measurement average uniformity calculator` | angle/replicate summary, range/CV, position map, lot comparator; 4+ | not molded color; generic statistics tools | HOLD |
| 42 | Surface-roughness profile reduction | machined/molded surface QA; summarize traces | `Ra Rq Rz calculator profile data` | Ra/Rq/Rz, cutoff segment, replicate comparator, CSV analyzer; 4+ | not defect mapping; metrology software strong | HOLD |
| 43 | Contact-angle/surface-energy reduction | bonding/printing lab; reduce droplets/liquids | `surface energy calculator contact angle Owens Wendt` | single-angle QC, two-liquid components, replicate/outlier, treatment comparator; 4+ | not plastic joining; scientific calculators fragmented | GO |
| 44 | Corona/plasma treatment energy dose | film converter; normalize power and web speed | `corona treatment watt density calculator` | W·min/m², electrode width/speed, lane allocation, scenario comparator; 4+ | not extrusion production balance; equipment vendors explain | GO |
| 45 | Plastic coating wet/dry thickness and coverage | coater; plan each batch/run | `wet film thickness dry film thickness solids calculator` | WFT/DFT, volume solids, area coverage, loss-adjusted quantity; 4+ | not molded marking; many generic coating calculators | HOLD |
| 46 | FDM extrusion/flow calibration | additive operator; calibrate printer/material | `3d printer flow calibration calculator` | wall measurement flow, E-steps ratio, line-width/volume, calibration log; 4+ | not industrial extrusion; strong free competitors | HOLD |
| 47 | Filament spool remaining/length planning | additive shop; plan jobs | `filament length weight remaining calculator` | length/mass, spool remainder, multi-job reserve, material/cost; 4+ | none; many free calculators | DROP |
| 48 | Print-farm capacity/job queue | additive-production lead; schedule jobs | `3d print farm capacity calculator` | machine-hours, batch allocation, failure/yield, due-date scenarios; 4+ | not molding scheduling; one capable free tool found | HOLD |
| 49 | Plastic pipe SDR/pressure design | piping engineer/installer; screen pipe geometry | `plastic pipe SDR pressure rating calculator` | SDR, wall/OD, hoop stress, derating, test pressure; 4+ | not tube extrusion drawdown; strong PPI/vendor tools | HOLD |
| 50 | Cellular-plastic apparent density/expansion | foam QA; reduce specimen and batch data | `foam apparent density expansion ratio calculator` | apparent/core density, expansion ratio, water uptake, compression recovery; 4+ | none; generic density tools/services | HOLD |

Broad outcome: 50/50 were outside the explicit reuse set. The first five are separate search families but combine naturally into one laboratory cluster; no production-film planning, extrusion balance, packaging-handoff, or existing injection-molding decision was relabeled.

#### Mid-list — strongest 12

| Rank | Candidate | Query variations and repeated intent | Independent tools | Actual/free competition and gap | Overlap / static feasibility |
|---:|---|---|---:|---|---|
| 1 | Film & flexible-packaging test data reduction | `film tensile strength calculator`, `film COF calculator`, `seal strength N/15 mm`, `T1 T2 T3 T4 haze`, `dart failure weight` | 5 strong | paid standards, labs, and equipment vendors; no reviewed free vendor-neutral five-test workflow | no overlap; simple deterministic JS |
| 2 | General polymer QC laboratory reduction | D792 density, MFI cut weights, ash %, flexural/impact normalization | 7+ | isolated calculators and quote funnels; still fragmented | no existing lab cluster; static, but broad method burden |
| 3 | Flexible-packaging barrier test & ingress planning | OTR/WVTR normalization, multilayer barrier, oxygen ingress, desiccant load | 5+ | Kitashikoku and simple WVTR tools cover slices | distinct from handoff; static with carefully bounded conditions |
| 4 | Polymer thermal-analysis reduction | DSC crystallinity, TGA loss, DMA modulus/tan delta, Vicat/HDT load | 5+ | ConductScience DSC tool plus instrument software | distinct from mold cooling; static arithmetic, method maintenance |
| 5 | Plastic CNC setup & workholding | plastics feeds/speeds, vacuum hold-down, CTE compensation, drilling/saw trials | 6+ | CNC Toolkit, EndMillCalc, generic vacuum/CTE tools are strong | new workflow; deterministic core but safe presets are empirical |
| 6 | Accelerated aging/environmental test planning | Arrhenius aging, UV dose, thermal cycles, chemical retention | 5+ | PackCalc covers aging; chamber vendors provide schedules | new; static scenarios, source-sensitive extrapolation |
| 7 | Plastic sheet fabrication planning | sheet yield, kerf, line bending, laser coupons, stock weight | 5+ | capable generic optimizers and weight calculators | new; static, but weak unified search identity |
| 8 | Polymer surface treatment/metrology | contact angle, surface energy, corona dose, gloss, roughness | 5+ | scientific calculators and equipment articles fragmented | new; static, needs clear instrument/method bounds |
| 9 | Additive-manufacturing production calibration | flow calibration, spool reserve, farm capacity, failure-adjusted scheduling | 5+ | mature free 3D-print tool ecosystem | new, static; weak SERP gap |
| 10 | Plastic pipe SDR/pressure screening | SDR, wall, hoop stress, derating, hydrotest planning | 5+ | PPI and pipe vendors offer authoritative tools | new; static, but competition/standards maintenance high |
| 11 | Cellular-plastic/foam physical-test reduction | apparent/core density, expansion, uptake, compression recovery | 4+ | services and generic formulas, few connected tools | new; static; demand map narrower |
| 12 | Optical/appearance test reduction | haze, transmittance, gloss, color-independent uniformity, surface maps | 4+ | instrument software and isolated formulas | molded-color exclusion respected; static, weaker coherence |

#### Deep-validation finalists, scoring, Gates, and why only one GO

Score components are Search/Long-tail (35), free-SERP gap (25), tool depth/repeat (20), commercial relevance (10), and static advantage (10).

| Finalist | Score | Component score | Core workflow / target user | Main query and meaningful long-tail intents | Competition and gap | Decision |
|---|---:|---|---|---|---|---|
| Film & flexible-packaging test data reduction | **87** | 30 / 22 / 18 / 7 / 10 | film, converter, and package labs reduce measured specimens/lots | `plastic film test calculator`; film tensile stress; film elongation; film COF; static vs kinetic COF; seal strength N/mm; seal strength N/15 mm; haze T1–T4; total transmittance; dart successive groups; dart 50% failure mass; film QC replicate comparison | ASTM pages are paid-method entry points; Fitco/COF Tester/Dart Drop Test are equipment or quote pages; no reviewed free five-test vendor-neutral workflow | **GO** |
| General polymer QC laboratory reduction | 84 | 31 / 17 / 18 / 8 / 10 | resin/part QC labs reduce routine property tests | `polymer test calculator`; D792 SG; density by immersion; melt-flow cut average; MFR/MVR; ash content; filler percentage; flexural strength; flexural modulus; Izod normalization; water absorption; chemical retention | Calculator Academy covers MFI; D792 and other SERPs are service funnels; tools remain fragmented, but the cluster spans too many apparatus/method identities | PASS gates, runner-up; higher maintenance and weaker single-workflow coherence |
| Flexible-packaging barrier test & ingress planning | 80 | 30 / 15 / 18 / 9 / 8 | package engineers connect measured barrier to package exposure | `package oxygen ingress calculator`; OTR normalization; WVTR normalization; permeance vs permeability; multilayer OTR; layer resistance; package area ingress; headspace oxygen; moisture ingress; desiccant sizing; shelf-life threshold; temperature/RH condition basis | Kitashikoku has a barrier calculator and Calculator Academy has WVTR; vendor models and spreadsheets cover slices | HOLD: deterministic accuracy gate fails for generalized condition conversion without validated material models |
| Polymer thermal-analysis data reduction | 75 | 24 / 19 / 16 / 7 / 9 | polymer labs reduce DSC/TGA/DMA/Vicat/HDT outputs | `polymer DSC calculator`; percent crystallinity; cold crystallization correction; filler correction; blend crystallinity; TGA mass loss; TGA residue/filler; DMA tan delta; complex modulus; glass-transition picker; HDT stress/load; Vicat load | ConductScience provides a usable DSC crystallinity calculator; instrument software dominates adjacent intents | HOLD: below aggressive score threshold; search identity and actionability are more instrument-specific |
| Plastic CNC setup & workholding | 72 | 34 / 7 / 17 / 8 / 6 | plastics machinists plan trials and workholding | `feeds speeds calculator plastics`; acrylic feed rate; chip load plastic; drilling plastic rpm; saw feed/tooth; vacuum hold force; sheet zone sizing; plastic CTE compensation; line-bend allowance; laser kerf offset; tapping engagement | CNC Toolkit and EndMillCalc provide strong generic calculation; many OEM/toolmaker charts exist | DROP: free gap weak and safe material/tool/machine presets are empirical, breaking deterministic-accuracy expectations |

Gate matrix (`P` pass, `F` fail). A Newness; B Demand; C independent depth; D SERP gap; E repeatability; F deterministic accuracy; G static feasibility; H distinctness; I coherence; J actionability; K maintenance; L independent-site reason.

| Finalist | A | B | C | D | E | F | G | H | I | J | K | L | Gate outcome |
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|---|
| Film/flexible-packaging test reduction | P | P | P | P | P | P | P | P | P | P | P | P | all pass |
| General polymer QC lab reduction | P | P | P | P | P | P | P | P | P | P | P | P | all pass, but lower coherence/gap quality than winner |
| Packaging barrier/ingress | P | P | P | P | P | **F** | P | P | P | P | P | P | generalized environment/material conversion not reliably deterministic |
| Polymer thermal analysis | P | P | P | P | P | P | P | P | P | P | P | P | all pass, score only 75 |
| Plastic CNC setup/workholding | P | P | P | **F** | P | **F** | P | P | P | P | P | P | crowded calculators and empirical preset risk |

Independent-site reason:

- Film test reduction: one mobile, deterministic, vendor-neutral, no-login/no-upload bench for five separately searched lab reductions, with units, physical validation, interpretation, and method boundaries on every result.
- General polymer lab: useful spreadsheet replacement, but a visitor is less likely to treat density, melt flow, ash, flexure, and impact as one task session.
- Barrier/ingress: scenario recomputation is valuable, but material permeability and environmental conversion can invite false precision unless the user already owns validated data/models.
- Thermal analysis: transparent arithmetic is valuable, but users often already work inside instrument software and definitions vary by method and baseline treatment.
- CNC plastics: rapid scenario comparison is valuable, but existing machining calculators plus machine/tool/material documentation remain the safer setup source.

Pages actually opened during competition validation included [ASTM plastics standards](https://store.astm.org/products-services/standards-and-publications/standards/plastics-standards.html), [Fitco F88 testing page](https://www.fitcoindia.com/testing-solutions/astm-standards/astm-f88/), [COF Tester film application](https://www.coefficientoffrictiontester.co/applications/plastic-films), [Dart Drop Test equipment/method page](https://www.dartdroptest.com/impact-testing-machine/), [Calculator Academy MFI](https://calculator.academy/melt-flow-index-calculator/), [ConductScience DSC crystallinity](https://conductscience.com/tools/dsc-crystallinity-calculator), [Infinita Lab D792](https://infinitalab.com/services/astm-d792-plastic-density-specific-gravity-testing/), [Kitashikoku barrier calculator](https://www.kitashikoku-g.co.jp/products-services/calculator/barrier.html), [Calculator Academy WVTR](https://calculator.academy/water-vapor-transmission-rate-calculator/), [CNC Toolkit](https://www.cnctoolkit.com/), [EndMillCalc](https://endmillcalc.com/), [PackCalc accelerated aging](https://packcalc.com/tools/accelerated-aging-calculator), [PPI leak-test pressure calculator](https://www.plasticpipe.org/EnergyPipingSystems/EPSD-Leak-Test-Pressure-Calculator.aspx), and [MakerPrintTools print-farm capacity](https://makerprinttools.com/tools/production/print-farm-capacity-calculator/). Competitor calculations were not used as technical authority.

#### Selected cluster and final tool specification

Selected cluster: **Plastic Film & Flexible Packaging Test Data Reduction**, implemented as a hub plus five strong calculator pages. The tools reduce already measured data; they do not reproduce paid standards, select acceptance limits, or claim compliance.

| Tool / registry key | Type and target query | User question | Inputs | Deterministic logic | Outputs / next action | Repeat and independence |
|---|---|---|---|---|---|---|
| Plastic Film Tensile Strength & Elongation / `film-tensile-strength` | calculator; `plastic film tensile strength calculator` | what stress and elongation correspond to this specimen? | width mm, thickness µm, gauge mm, force N, extension mm | section = width × thickness; MPa = N/mm²; elongation = extension/gauge | MPa, %, section; compare valid same-basis replicates | every direction/lot; unique tensile specimen/decision |
| Plastic Film Coefficient of Friction / `film-coefficient-of-friction` | calculator; `plastic film coefficient of friction calculator` | what static/kinetic COF follows from sled forces? | sled g, peak N, sliding N | normal force = mass × 9.80665; force/normal | static and kinetic COF, normal force; review handling/surface pair | every surface/lot/treatment; unique friction trace |
| Flexible Package Seal Strength / `flexible-package-seal-strength` | calculator; `seal strength N 15 mm calculator` | what normalized peak/average strength follows from this peel? | width mm, peak N, average N | force/width and ×15 conversion; average cannot exceed peak | N/mm and N/15 mm; pair with failure mode | each seal condition/lot; unique peel normalization |
| Plastic Film Haze & Transmittance / `plastic-film-haze` | calculator; `film haze T1 T2 T3 T4 calculator` | what corrected haze/transmittance follows from readings? | T1–T4 same-scale readings | total = T2/T1; corrected diffuse = (T4−T3×total)/T1; haze = diffuse/total | haze %, total and diffuse transmittance; reject nonphysical readings | every position/lot; unique optical instrument reduction |
| Plastic Film Dart Impact Failure Weight / `dart-impact-failure-weight` | calculator/validator; `dart impact failure weight calculation` | what 50% mass follows from five successive groups? | lowest g, increment g, group size, five failure counts | whole/nondecreasing/bounded validation; `WF = WL − ΔW(S/100 − 0.5)` | estimated g, highest level, summed failure %; verify lab report | every group series; explicitly not staircase data |

Technical authorities and implementation boundaries:

- [ASTM D882](https://store.astm.org/d0882-18.html), [ASTM D1894](https://store.astm.org/standards/d1894), [ASTM F88/F88M](https://store.astm.org/f0088_f0088m-21.html), [ASTM D1003](https://store.astm.org/d1003-00.html), and [ASTM D1709](https://store.astm.org/d1709-16.html) anchor terminology and method identity. The current licensed edition and laboratory SOP govern specimens, apparatus, sequence, invalid tests, rounding, and reporting.
- No proprietary standard text or competitor JavaScript was copied. The pages publish only transparent arithmetic, input semantics, worked examples, interpretation, limitations, and verification guidance.
- Dart impact is intentionally the five-equal-group successive-group arithmetic screen. Staircase/up-and-down observations are rejected as unsupported by this page.

#### Implementation, URLs, and QA

- New URLs:
  - `https://plasticscalc.com/tools/film-testing/`
  - `https://plasticscalc.com/tools/film-testing/film-tensile-strength.html`
  - `https://plasticscalc.com/tools/film-testing/film-coefficient-of-friction.html`
  - `https://plasticscalc.com/tools/film-testing/flexible-package-seal-strength.html`
  - `https://plasticscalc.com/tools/film-testing/plastic-film-haze.html`
  - `https://plasticscalc.com/tools/film-testing/dart-impact-failure-weight.html`
- Added `assets/js/film-testing-calculators.js`, scoped generator `film-testing-pages.mjs`, and independent verification `film-testing-calculator-tests.mjs`. Internal discovery links were added only at marked insertions on Home, Tool Index, and Materials. Global navigation, desktop header, shared mobile menu logic, global layout CSS, footer, consent code, and owner badge markup were not modified.
- Every calculator page contains Formula and method, Inputs and units, Worked example, When to use it, How to interpret the result, Assumptions and limitations, Validation guidance, FAQ, Sources, canonical, OG, H1, and JSON-LD.
- Independent fixtures: 15 numerical fixtures (three per tool) plus three explicit invalid-state fixtures passed. Default worked examples are independently asserted against registry output.
- Full automated regression passed: calculator core (33), 63-page registry/page parity, calculator UI, consent, content value, DFM (12), energy (12), extrusion (18), film-testing (15+3), markup across 102 HTML files, masterbatch (7), mobile header across 102 files, pre-expansion audit, thermal (45), validation (32), validation contrast, all JS/MJS syntax, and `verify.mjs` (102 public, 101 indexable/sitemap, zero issues).
- Browser QA used the Codex in-app browser against the local HTTP build. New pages: 6 × 6 viewports (390, 768, 900, 1024, 1280, 1440) = 36. Existing regression: 12 pages × 3 viewports (390, 1024, 1440) = 36. Total = **72 page-viewports**. Existing sample: Home, Tool Index, Injection hub, Extrusion hub, Materials hub, four existing calculators, Masterbatch, About, and Contact.
- All 72 checks reported zero horizontal overflow, header/H1 overlap, main/footer overlap, calculator-panel overlap, clipped monitored text, off-viewport inputs/buttons, and broken images. Browser console warnings/errors: zero.
- Real calculator interaction: all five tools passed default, modified input/recalculate, Reset, invalid input, and boundary input, for 25 explicit states. Modified expected results were 50 MPa, 0.25 static COF, 7.2 N/15 mm, 10% haze, and 70 g. Boundary results stayed finite/valid; invalid inputs showed `Check inputs` and a visible alert.
- Six full-page 390px screenshots were opened and visually inspected. Long H1s/labels wrap, units remain adjacent and readable, buttons remain full-width/usable, the result panel follows inputs, method/decision/source blocks remain legible, and the footer is intact. A computed-contrast audit initially found 3.50:1 white text on the orange Calculate button; a film-page-scoped dark text fix raised the normal-state minimum to **4.51:1** without changing global CSS. Production interaction then exposed a 2.88:1 dark-text/dark-orange hover state; a scoped hover/focus rule restored light text and measured **5.49:1**. Final normal/hover monitored minimum is 4.51:1; other ratios are unit 6.06, source link 7.13, help/method 13.05, result detail 13.88, and label/result number 16.36.
- Shared-component preservation: homepage owner suffix remained 6 links/6 images/one `data-kittylaunch-badge`; its exact suffix SHA-256 before generation was `957B86CBECD60D6D2FE57A7F2D203007B274E7007CACB059A129E2FD854E1521` and remains unchanged. Fresh 390px navigation showed hidden menu → MENU open (`aria-expanded=true`) → Escape close. Consent remains intentionally suppressed on localhost and its separate regression suite passed.
- Post-work inventory: **102 public HTML**, **101 indexable/sitemap URLs**, **63 calculator pages/registry entries**.
- Quality risk: **HIGH — none introduced. MEDIUM —** current paid standard editions and each laboratory SOP must still control specimen validity, apparatus, method choice, significant figures, and conformance; the D1709 successive-group screen must not be used for staircase data; no first-party query/traffic export was available, so demand confidence is qualitative SERP/workflow evidence rather than claimed volume.
- Release and production verification: implementation commit `6be00c7efe76f5b2e4261fbdd912760c94eda1df` deployed successfully in Pages run [33456867101](https://github.com/canghun13/plasticscalc/actions/runs/33456867101). Production QA found and corrected the hover-only contrast issue in commit `34539d647e27d7eaf47a68f0bff24cca77cd4fd8`; Pages run [33457130744](https://github.com/canghun13/plasticscalc/actions/runs/33457130744) completed successfully. At the final code deployment, the live 390px hub showed all five tool links, intact mobile menu/footer/consent, zero overflow and broken images. Live Haze recalculated from 3.848% to 10%; live Dart recalculated 140→144 g and Reset restored 140 g. Final hover contrast was 5.49:1, and production console warnings/errors, overflow, overlap, clipping, and broken images were all zero. The post-deployment handover commit is documentation-only; production functionality is represented by `34539d6`.
...
- HIGH: none. MEDIUM: no first-party GSC/GA4/Bing search/landing-page exports; extrusion search opportunity therefore rests on observable multi-query SERP and engineering evidence rather than measured traffic.
- Release: implementation commit `a9011bbf546547cb042e50a5d777e06a4973123f` was pushed to `main`; local HEAD, `origin/main`, and `git ls-remote origin refs/heads/main` matched. GitHub Pages run [32936212661](https://github.com/canghun13/plasticscalc/actions/runs/32936212661) completed successfully for that exact SHA.
- Production spot-check: cache-bypassed `https://plasticscalc.com/tools/extrusion/` and `https://plasticscalc.com/tools/extrusion/extrusion-drawdown-ratio.html` returned the new titles/H1s and expected `2.857 :1` default result at 1024px and 390px. Overflow and console warnings/errors were 0; footer and responsive MENU were present. A full-page production 390px screenshot was visually inspected and the result, inputs, source blocks, related workflow, consent, and footer were readable.
- Operating readiness: **yes**. The cluster is deployed and may remain in normal operation. The final documentation commit that contains this release record is the immediate successor to `a9011bb` and is verified against remote after push.
...
- Data availability: as of **2026-08-24**, no GSC Performance/Coverage export, GA4 landing-page export, Bing export, keyword report, or page-traffic export was present in the repository, supplied attachments, or retained project files. No impressions, clicks, rankings, CTR, sessions, or conversion behavior were inferred. Phase 1 therefore required observable current-page risk plus external engineering/market evidence, not speculative traffic claims.
- Exclusions: the 2026-08-20 Runner Volume, Clamp Tonnage, Cycle Time, Shot Size, and OEE candidates were not reopened. All recent GO clusters and HOLD/REJECT/NO-GO families in this log were excluded. The four new existing-asset candidates were Residence Time, Masterbatch Dosage, Material Cost Per Part, and Mold Amortization.
- Phase 1 scoring (Search/Growth 35 + User Value 25 + Evidence Strength 20 + Existing Asset Leverage 10 + Implementation Efficiency 10):

  | Existing-page candidate | Growth | User | Evidence | Leverage | Efficiency | Total | Gate result |
  | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
  | **Masterbatch Dosage: explicit basis, active-content mode, and both LDR conventions** | 27 | 25 | 18 | 10 | 9 | **89** | **U-A–U-E PASS / GO** |
  | Residence Time: rated-shot/barrel-factor estimator and guidance | 28 | 22 | 14 | 10 | 8 | **82** | U-E FAIL / OBSERVE |
  | Material Cost Per Part: broader conversion-cost composition | 27 | 21 | 14 | 10 | 8 | **80** | U-E FAIL / OBSERVE |
  | Mold Amortization: maintenance timing and volume scenarios | 24 | 19 | 12 | 10 | 9 | **74** | U-E FAIL / OBSERVE |

- Hard gates for the selected upgrade: **U-A Evidence PASS** — the existing page itself warned that dosage may mean base resin or total blend while exposing only one base-resin formula; MOCOM requires exact dosage, compatible carrier and calibrated feeding, while Ampacet documents let-down ratios and concentration examples. **U-B User benefit PASS** — the change prevents a real recipe-definition error. **U-C Measurable PASS** — independent total-basis, base-basis, active-content and equivalent-definition fixtures are deterministic. **U-D Low regression risk PASS** — one registered calculator, its generated page, three existing hub cards, the scoped generator source and tests changed; URLs, count, CSS, global header/footer, badges, sitemap and loader did not. **U-E Better now than observe PASS** — unlike the other candidates, this was a reproduced mismatch between caution copy and executable behavior, so first-party traffic data was not needed to justify fixing it now.
- Current evidence reviewed: [MOCOM masterbatch guideline](https://www.mocom.eu/dam/jcr%3A9e0f2ef6-838d-4415-b660-d1247ea91f5b/MOCOM%20-%20Guideline%20Alcolor%20%26%20Alperform%20Masterbatches%20EN.pdf), [Ampacet let-down guidance](https://www.ampacet.com/faqs/designing-high-performance-pipe-compounds/), and the current [Allzone Masterbatch Let-Down Ratio Calculator](https://allzonetrading.ca/knowledge/polymer-plastics/tools/masterbatch-let-down-ratio-calculator). Competing Residence Time and cost calculators confirmed intent, but not a PlasticsCalc defect or a superior reason to modify those stable pages now.
- Phase 1 decision: **GO — Masterbatch Dosage & Let-Down Ratio Calculator, 89/100**. Phase 2 was not run, per the stop rule after a Phase 1 GO.
- Implementation: `assets/js/phase3-calculators.js` now supports (1) supplier dosage as percent of finished total blend, (2) supplier dosage added to base resin, and (3) target final active content from masterbatch active concentration. Every valid result reports masterbatch, base resin, total batch, total-blend percentage, base-addition percentage, total-to-masterbatch ratio, and base-to-masterbatch ratio. Mode-specific fields are hidden and disabled, the mass label follows the basis, reset restores the total-blend default, and blank/zero/out-of-range inputs produce field-specific accessible errors. The stable URL is unchanged.
- Content and generator: `phase3-pages.mjs` contains the three formulas, basis instruction, worked example, MOCOM/Ampacet sources, limitation, and a safe `--only=<tool>` generator mode so one Phase 3 page can be regenerated without rewriting hubs, guides, sitemap, or owner-managed suffixes. `tools/injection-molding/masterbatch-dosage.html` has unique matching title/H1/metadata and the documented 200 kg at 2% example. Existing Tool Index, Injection Molding hub and Materials hub cards were updated; no global CSS or shared footer/navigation markup changed.
- Independent fixtures: `masterbatch-dosage-tests.mjs` covers seven recipes across all three modes, decimals, equivalent total/base definitions, unit/detail contracts, mode visibility, formulas, worked example and sources. `calculator-tests.mjs` also contains production-registry regressions for all three modes.
- Final automated verification: all **15** test files passed after the last code change. `verify.mjs` reported 89 HTML, 88 indexable, 89 unique titles/canonicals, 88 sitemap URLs and zero issues; markup 89/89; mobile header 89/89; registry 52/52; calculator UI 52/52; legacy/Phase 3 registry 33; masterbatch fixtures 7; thermal 45; validation 32; validation contrast; energy 12; DFM 12; consent; content value; and pre-expansion audit. Changed JavaScript/generator files passed `node --check`; `git diff --check` passed.
- Real browser QA: the changed calculator passed **390, 768, 900, 1024, 1280, and 1440 px** at 900 px height with no horizontal overflow, clipping or hidden-field leakage; result contrast measured **16.36:1**. Total, base and active modes produced 15 kg, 4 kg/204 kg total, and 30 kg in changed-input tests; reset returned 4 kg; blank mass, 100% dosage and target equal to concentrate active content produced `Check inputs` plus the expected accessible field error. Mobile MENU open/close, consent display/dismiss, sources, formula, example, footer and labels were verified. Representative regression covered Home, Tool Index, Injection Molding hub, Materials hub, Regrind Blend, Resin Purchase Quantity, Material Cost, and Method at **390/1024/1440 px (24 page-viewports)** with zero failures; all three home checks retained exactly six primary tool cards.
- Remaining risk: **HIGH none**. **MEDIUM:** no first-party search/traffic export exists, so the growth score rests on durable intent and a proven usability/engineering defect rather than measured PlasticsCalc demand. Supplier terminology can still vary, which is why the UI requires an explicit basis and the page states that it does not select a dosage, approve compatibility, replace feeder calibration, or replace production trials. Operational readiness: ready for production after remote/deployment verification.
...
### 2026-09-07 Regrind Blend targeted search-signal upgrade

- Repository/start state: worked in `C:\Users\song\Documents\ChatGPT\plasticscalc\canonical` on clean `main`, remote `https://github.com/canghun13/plasticscalc.git`, starting commit `25fb6e9661aef0c098e39277215e7b2e84992e5b`. Local HEAD, `origin/main`, and `git ls-remote origin refs/heads/main` matched before editing. Pre-work inventory was 102 public HTML files, 101 indexable/sitemap URLs, and 63 calculator tools. The latest completed cluster remained Plastic Film & Flexible Packaging Test Data Reduction.
- Search signal: used the owner-provided current GSC snapshot as supplied, not reconstructed: approximately 115 impressions, 0 clicks, 0% CTR, average position approximately 4.93, versus the earlier approximately 59 impressions, 0 clicks, and position 5.29. No first-party query export was available in the repository.
- Query/intent review: checked `regrind blend calculator`, `regrind percentage calculator`, `virgin regrind ratio calculator`, `virgin resin regrind blend`, `plastic regrind ratio`, `regrind mix calculator`, `regrind material calculator`, `injection molding regrind percentage`, `regrind dilution`, `virgin resin to regrind ratio`, and recycled/regrind blending variants. The results divide into deterministic batch-recipe/formula intent, material-specific allowable-percentage guidance, vendor blending equipment, and broader recycled-content topics. Only the first group belongs in this calculator.
- SERP/competitor findings: the live Dri-Air page is a quote-led virgin/regrind equipment page with on-the-fly ratio adjustment, not a standalone recipe calculator. The live JeekMould result is a process-guidance article that explains 20 kg regrind plus 80 kg virgin for a 20% total-batch blend and also discusses material-specific trial ranges; it was treated as competitor coverage, never as authority for a generic limit. The legacy CustomPartNet result exposes regrind-ratio controls inside a broad injection-molding cost estimator, but its page could not be safely opened because of its current certificate/fetch failure. The Movacolor MCTC equipment manual provides the authoritative deterministic contract used here: regrind equals batch/shot weight multiplied by regrind percentage, with explicit 20% and 25% examples. Search results also showed repeated shop-floor demand for weighing virgin and regrind in the correct proportions.
- Product gap and gates: the old page exposed only total mass and percentage, promoted regrind mass, buried virgin mass in one detail sentence, used kg only, and did not label total-batch percentage basis or either ratio direction. Gate A PASS (the sustained top-five/zero-click signal aligns with calculator and recipe intent); B PASS (reproducible recipe-information gap); C PASS (weighing/setup handoff is materially clearer); D PASS (pure mass-balance arithmetic with 0%/100% handling and no inferred limits); E PASS (functional and workflow improvement beyond metadata). Decision: **GO**.
- Scope implemented: retained the existing URL, title, and H1 because they already match the primary query. Refined only the description/intro to state the delivered recipe. Added a kg/lb mass-unit selector, a structured recipe table for virgin resin, regrind, total blend, virgin/regrind shares, explicitly labeled Virgin:Regrind and Regrind:Virgin ratios, and human-readable material-only states at 0% and 100%. Hard-coded comparison presets were not added because side-by-side scenario demand was not sufficiently evidenced; users can recalculate any approved percentage. Masterbatch active content, pigment, LDR, additives, recycled-content certification, property prediction, and recommended regrind thresholds remain out of scope.
- Calculation/validation contract: `regrind = total × percentage / 100`; `virgin = total − regrind`; the percentage is explicitly the regrind share of the finished virgin-plus-regrind batch. Total must be finite and greater than zero; percentage must be finite and from 0% through 100%; unsupported units are rejected; number inputs browser-reject literal `NaN`/`Infinity`; invalid states hide the stale recipe. The 20% default is explicitly an arithmetic example, not a recommendation.
- Content/workflow: added weighing guidance, total-batch interpretation, clean/segregated material, material identity, drying/contamination control, scale consistency, lot traceability, production-trial and customer/specification boundaries. Related links are limited to Materials, Injection Molding, Scrap/Regrind planning, Scrap Rate, Resin Purchase Quantity, Material Cost, and a clearly separate Masterbatch workflow.
- Modified runtime/source files: `assets/js/phase3-calculators.js`, `phase3-pages.mjs`, generated `tools/injection-molding/regrind-blend.html`, and `calculator-tests.mjs`. Added `regrind-blend-tests.mjs`; this handover entry is the only documentation change. New public pages: 0. No global CSS, common container/spacing/typography, header, mobile menu, footer, analytics-consent code, sitemap, or hub page was changed. The safe `node phase3-pages.mjs --only=regrind-blend` path alone regenerated the target.
- Independent fixtures: six explicit recipes passed: 100 kg at 20%, 25 kg at 7.5%, 1,000 lb at 30%, 0%, 100%, and a 0.01% very-small boundary. Nine explicit invalid contracts passed: blank/zero total, negative/NaN/Infinity total, negative/over-100/NaN/Infinity percentage, and unsupported unit. Expected masses, percentages, units, and ratio strings are literal fixture values rather than outputs derived from the production implementation.
- Automated regression: every repository `*tests.mjs` suite passed, including registry/page parity 63/63, calculator UI 63 pages, legacy/Phase 3 core 33, consent, content value, DFM 12, energy 12, extrusion 18, film testing 15+3, markup 102 pages, masterbatch 7, mobile header 102 pages, pre-expansion audit, regrind 6+9, thermal 45, validation 32, and validation contrast. `verify.mjs` passed with 102 HTML, 101 indexable, 102 unique titles/canonicals, 101 sitemap URLs, and zero issues. All JS/MJS syntax checks and `git diff --check` passed.
- Browser QA: the local target passed at 390, 768, 900, 1024, 1280, and 1440 px. Homepage, Tool Index, Injection Molding Hub, Materials Hub, Masterbatch Dosage, Resin Purchase Quantity, and Material Cost passed at 390, 1024, and 1440 px (21 page-viewports). All had one H1, zero horizontal overflow, no detected clipping, no broken images, no visible `NaN`/`Infinity`/`undefined`, no header/H1 overlap, usable 42 px or taller controls, expected mobile-menu behavior, and visible footer. Target interactions covered initial/default, 25 kg at 7.5%, 1,000 lb at 30%, recalculation, reset, blank, zero/negative total, blank/over-100 percentage, 0%, 0.01%, 100%, unit selection, and browser-native rejection of `NaN`/`Infinity` literals. Console warnings/errors were zero.
- Readability/contrast: the 390 px screenshot was visually inspected at both the input and recipe/result portions. Computed contrast was 16.36:1 for the primary result and ratio values, 14.52:1 for recipe mass/percentage cells, 10.08:1 for table headers, 10.94:1 for row labels/helper text, 9.60:1 for the result label, 13.88:1 for result detail, 6.06:1 for unit helper text, and 12.25:1 for limitation text; all reviewed normal text exceeds 4.5:1.
- Print/Copy: not applicable. The current calculator architecture has no Copy Result or Print feature, and this change did not remove or alter one.
- Owner-managed protection: homepage suffix after `</footer>` remained exactly 1,731 characters with six badge links, six images, one KittyLaunch badge element, the same 12 `href`/`src` values, and SHA-256 `957B86CBECD60D6D2FE57A7F2D203007B274E7007CACB059A129E2FD854E1521`. Browser rendering found all six links/images and zero broken badge images.
- Post-work inventory remains 102 public HTML files, 101 indexable/sitemap URLs, and 63 tools. HIGH: none. MEDIUM: allowable regrind remains grade/customer/regulatory/process specific; the search diagnosis uses the supplied aggregate GSC snapshot because no current query export is in the repository. Implementation commit `af1cd69f72eb0e8cd4aa8b5f096a20ec721dfafa` received a successful GitHub Pages deployment (Actions run `34072692801`). The exact production URL then passed at 390 and 1024 px: new inputs and recipe were present, 1,000 lb at 30% and 25 kg at 7.5% recalculated correctly, reset restored 500 kg at 20%, result text remained readable, overflow/broken images/visible invalid literals were zero, footer remained present, and console warnings/errors were zero. Operationally ready; the following documentation-only commit records this completed verification without changing runtime output.

---

### 2026-09-11 Long-standing Google Discovered-not-indexed diagnosis — NO-CHANGE

- Repository/start state: worked in `C:\Users\song\Documents\ChatGPT\plasticscalc\canonical` on clean `main`, remote `https://github.com/canghun13/plasticscalc.git`, starting commit `65ae44bc7973f89330234a9a455408d95ea90471`. Before diagnosis, local HEAD, `origin/main`, and `git ls-remote origin refs/heads/main` matched. Pre-work inventory was 102 public HTML files, 101 indexable/sitemap URLs, and 63 calculator tools.
- Coverage evidence: used the owner-provided current weekly snapshot as supplied because no current GSC Coverage export exists in the repository: approximately 1,936 cumulative impressions and 36 clicks, improving recent-seven-day average position, approximately 15 URLs in `Discovered – currently not indexed`, and one DFM Hub URL in `Crawled – currently not indexed`. The six recently deployed Film Testing URLs remain an observation cohort, not a defect cohort: `/tools/film-testing/`, `/tools/film-testing/film-tensile-strength.html`, `/tools/film-testing/film-coefficient-of-friction.html`, `/tools/film-testing/flexible-package-seal-strength.html`, `/tools/film-testing/plastic-film-haze.html`, and `/tools/film-testing/dart-impact-failure-weight.html`. No Film Testing file was changed.
- Older diagnostic cohort and origin: Cooling Time, Cycle Time, Parts per Hour, and Materials Hub date to the 2026-07-18 base build; Runner Volume, Fill Time, and Scrap-Adjusted Output date to the 2026-07-22 Phase 3 expansion; Rib Design Checker and Wall Thickness Uniformity date to the 2026-08-14 DFM cluster. Exact production targets were `/tools/injection-molding/runner-volume.html`, `/tools/injection-molding/cooling-time.html`, `/tools/injection-molding/cycle-time.html`, `/tools/injection-molding/fill-time.html`, `/tools/injection-molding/parts-per-hour.html`, `/tools/injection-molding/scrap-adjusted-output.html`, `/tools/injection-molding/rib-design-checker.html`, `/tools/injection-molding/wall-thickness-uniformity.html`, and `/tools/materials/`. `/tools/injection-molding/injection-molding-part-design-dfm.html` was inspected separately as the crawled-not-indexed comparison.
- Runner Volume evidence: Google still reports the page as discovered but not indexed, while the owner-provided Bing signal is approximately seven impressions, four clicks, 57% CTR, and average position approximately 2.29. This supports continued observation and argues against treating the page as valueless; it does not justify an indexing workaround.
- Crawlability and URL consistency: all ten production URLs returned HTTPS 200, `text/html; charset=utf-8`, with zero redirects. Every page has one exact self-referencing canonical matching its served URL and sitemap URL; Materials correctly uses the trailing-slash `/tools/materials/` canonical. None has a robots meta restriction, `noindex`, `nofollow`, `X-Robots-Tag`, alternate/hreflang conflict, host mismatch, or apex/www mismatch. `robots.txt` allows `/` and names the production sitemap. Every target occurs exactly once in `sitemap.xml`; the full verifier reports 101 sitemap URLs, 101 indexable pages, unique canonicals, and no sitemap issue.
- Production/source alignment: all ten served HTML bodies matched the checked-out source text exactly. Served `sitemap.xml` and `robots.txt` matched after normalizing the expected CRLF-to-LF transport difference. Therefore none of the targets is a stale generated artifact with old canonical, navigation, metadata, or links.
- Internal discoverability: static-HTML inbound-link counts were Runner Volume 5, Cooling Time 16, Cycle Time 11, Fill Time 4, Parts per Hour 8, Scrap-Adjusted Output 2, Rib Design Checker 1, Wall Thickness Uniformity 2, Materials Hub 101, and DFM Hub 8. Runner is linked from Home, Tool Index, Injection Molding Hub, the runner/sprue guide, and Sprue Volume. Fill and Scrap are directly linked from both Tool Index and Injection Molding Hub; Fill also has two process-tool links. Cooling, Cycle, and Parts per Hour have hub, home, guide, and related-tool paths. Materials is in the global primary navigation. Rib's single direct inbound is the semantically correct DFM workflow hub, itself linked from Home, Tool Index, and Injection Molding Hub; Wall is linked from that hub and its measurement guide. The DFM hierarchy is deliberate hub-to-child navigation, not an orphan or broken discovery path. All links are ordinary crawlable anchors.
- Content differentiation: all target titles, H1s, descriptions, canonicals, formulas, inputs, result units, examples, decision uses, and limitations are specific to their calculation or hub. Static visible word counts range from 270 to 648 in the older cohort. Shared Phase 3 framing produces high template-text similarity for Runner versus Sprue (0.763), Fill versus Screw Recovery (0.730), and Scrap-Adjusted Output versus Screw Recovery (0.743), but the user intent and calculation contract remain distinct: geometry volume, volumetric fill duration, and yield-adjusted production output respectively. DFM child pages contain feature-specific ratios, project boundaries, interpretation, validation guidance, and sources; the DFM Hub is a four-step navigation/workflow page rather than a duplicate calculator. No filler expansion or intent-merging change was warranted.
- Renderability/runtime: title, meta description, canonical, H1, intro, formula/method, examples, interpretation, limitations, FAQ/workflow links, and hub copy are present in initial HTML without JavaScript. JavaScript is limited to calculator controls/results and navigation behavior; every referenced local script exists, registry/page parity passes 63/63, and no loader mismatch was found. In the production browser, all ten URLs rendered the expected H1/canonical and full body; all eight calculator pages hydrated finite default results. At a 1,265 px viewport every page had `scrollWidth === clientWidth`, and accumulated console warnings/errors were zero. Runner Volume was interactively recalculated from 10 mm diameter and 1,000 mm total length to 78.54 cm³ with no console error.
- Classification: Runner Volume, Cooling Time, Cycle Time, Fill Time, Parts per Hour, Scrap-Adjusted Output, Rib Design Checker, Wall Thickness Uniformity, and Materials Hub are all **Type 4 — No defect found**. The DFM Hub comparison is also Type 4 at the site layer, while its GSC state remains a separate `Crawled – currently not indexed` selection signal. No Type 1 technical blocker, Type 2 discoverability weakness, or Type 3 content/intent duplication requiring a site change was confirmed.
- Root cause/decision: no actionable site-side root cause was found. The evidence is most consistent with Google crawl scheduling/index selection lag, not blocked crawling, malformed URL signals, orphaning, stale deployment, empty rendering, or indistinguishable intent. Final decision: **NO-CHANGE**. Production changes: 0; new public pages: 0; only this handover record changed. No sitemap timestamp refresh, forced internal-link block, title rewrite, content padding, Film edit, Indexing API submission, or other crawl manipulation was performed.
- Validation/protection: `verify.mjs` passed with 102 HTML files, 101 indexable pages, 102 unique titles/canonicals, 101 sitemap URLs, and zero issues; calculator registry/page parity passed 63/63. The owner-managed homepage suffix after `</footer>` remains 1,731 characters with six badge links, six images, one KittyLaunch badge element, the same 12 `href`/`src` values, and SHA-256 `957B86CBECD60D6D2FE57A7F2D203007B274E7007CACB059A129E2FD854E1521`. No global layout, header, mobile menu, footer, consent, runtime, HTML, CSS, JS, generator, or badge file was touched.
- Post-work inventory remains 102 public HTML files, 101 indexable/sitemap URLs, and 63 tools. HIGH: none. MEDIUM: the diagnosis relies on the owner-provided aggregate Coverage snapshot because the repository contains no current GSC URL export; Google indexing remains externally controlled. Documentation-only commit `da4be1464148ccdc04aa46dd833b7dad3f322ad2` received a successful GitHub Pages deployment (Actions run `34551174949`). After that deployment, Runner Volume again returned HTTP 200 with the exact self-canonical, no `X-Robots-Tag`, and an HTML body matching source; a fresh production-browser load showed the 22.62 cm³ default result, zero horizontal overflow, and zero console warnings/errors. Next observation: after Google has had a normal recrawl window, compare the same exact nine older URLs separately from the six recent Film URLs and the crawled DFM Hub. Re-open site-side work only if a URL develops a changed technical signal (non-200/redirect, robots or canonical mismatch, sitemap omission, broken crawlable path, render failure) or if current URL-level Coverage/export evidence identifies a reproducible shared pattern; otherwise continue observation without forced edits.
